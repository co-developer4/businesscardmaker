...
const Header = () => {
    return (
        <div className="flex px-5 lg:px-10 justify-between border-b h-[7vh] items-center">
            <div className="logo">
